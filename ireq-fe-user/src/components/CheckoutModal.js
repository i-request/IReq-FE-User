...
class TestModal extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <button onClick={this.openModal} className="modal-pay-btn">Checkout</button>
        <Modal isOpen={this.state.modalIsOpen} onRequestClose={this.closeModal} style={customStyles} contentLabel="Example Modal">

          <h3 className="model-form-header" ref={subtitle => this.subtitle = subtitle}>Checkout</h3>
          <form onSubmit ={(e) => e.preventDefault()}>
            <div className="modal-dialog" role="document">
              <div className="modal-content form-custom-style">
                <div className="modal-body">
                  ...
                  <div className="row">
                    <div className="form-group col-12">
                      ...
                      <textarea id="custAdditionalInfo" className="form-control" onChange={this.props.handleMessage} rows="1" placeholder="Additional information"></textarea>
                    </div>
